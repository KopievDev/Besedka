...
class ProfileView: UIView {
    ...
    private func createConstraints() {
        NSLayoutConstraint.activate([
            ...
            avatarImageView.topAnchor.constraint(equalTo: safeAreaLayoutGuide.topAnchor, constant: 60),
            avatarImageView.leadingAnchor.constraint(equalTo: safeAreaLayoutGuide.leadingAnchor, constant: 70),
            ...
            editButton.bottomAnchor.constraint(equalTo: safeAreaLayoutGuide.bottomAnchor, constant: -25 ),
            ...
            saveGCDButton.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 25),
            saveGCDButton.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -25),
